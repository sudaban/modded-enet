        ...
        else
        {
            ...
            if (host->serverUsesNewProto) {
                ...
                if ((integrity[0] < 0 ||
                    ...
                    integrity[2] == peer->nonce) // NONCE WARNING!!
                    return 0;

                peer->nonce = integrity[2]; // CAREFUL FOR NONCE!!
            }
        }
...
{
    size_t packetSize = host->clientUsesNewProto ? sizeof(ENetNewProtocolHeader) : sizeof(ENetProtocolHeader);
